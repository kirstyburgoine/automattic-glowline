...
Class LFB_Front_end_FORMS {
    ...
    function lfb_front_end_field_type_submit($data_array,$captcha_option){
        ...
        // submit button
       $submit .= '<div class="submit-type lf-field"><label><input id="' . $data_array['field_id'] . '" class="lf-form-submit" type="submit" name="' . $data_array['field_name'] . '" value="' . $data_array['default_value'] . '"/>
                </label></div>';
        return $submit;        
    }
}