...
include_once( plugin_dir_path(__FILE__) . 'inc/lf-install.php' );
include_once( plugin_dir_path(__FILE__) . 'inc/lf-shortcode.php' );
if(current_user_can('activate_plugins')){
include_once( plugin_dir_path(__FILE__) . 'inc/edit-delete-form.php' );
include_once( plugin_dir_path(__FILE__) . 'inc/create-lead-form.php' );
}
include_once( plugin_dir_path(__FILE__) . 'inc/email-setting.php' );
include_once( plugin_dir_path(__FILE__) . 'inc/show-forms-backend.php' );
include_once( plugin_dir_path(__FILE__) . 'inc/front-end.php' );
include_once( plugin_dir_path(__FILE__) . 'inc/show-lead.php' );
include_once( plugin_dir_path(__FILE__) . 'inc/lead-store-type.php' );
include_once( plugin_dir_path(__FILE__) . 'inc/ajax-functions.php' );
include_once( plugin_dir_path(__FILE__) . 'inc/lfb_widget.php' );